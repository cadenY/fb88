...
jq(document).ready(function() {
   var url = window.location.href.toString(),
       str = url.indexOf("/payment/"), prefix = '';
       (str != -1 ? prefix = '../' : prefix = '');
   var sidebar = '<div id="btn-download">'
      +'<div class="slidingDiv">'
           +'<div class="slideIconTop"><img src="'+prefix+'images/casino/leftpush/top.png"></div>'
           ...
           +'</div>'
      +'</div>'
      +'<div id="btnCloseDownload"> <img src="'+prefix+'images/casino/leftpush/close-button.png" alt=""></div>'
   +'</div>'
   +'<div id="btn-Chat">'
      +'<div class="imgCustomerServ"><img src="'+prefix+'images/casino/girl-chat.png"></div>'
      +'<div class="tcenter bottommargin-sm"><img src="'+prefix+'images/casino/24-7.png"></div>'
      +'<div class="waysto clearfix">'
           +'<div class="col_half nomargin tcenter"> <img src="'+prefix+'images/casino/deposit-icon.png" />'
               +'<br>'
               +'<div class="">How to <br> Deposit</div>'
           +'</div>'
           +'<div class="col_half col_last nomargin tcenter"> <img src="'+prefix+'images/casino/withdraw-icon.png" />'
               +'<br>'
      ...
      +'<p id="btnCloseChat"><img src="'+prefix+'images/casino/leftpush/help-center.png" alt=""></p>'
   +'</div>';
